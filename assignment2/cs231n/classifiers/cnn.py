...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        out_2, cache_2 = affine_relu_forward(out_1, W2, b2) # out.reshape(N,-1)
        ...
        dout, grads['W3'], grads['b3'] = affine_backward(dout, cache_3)
        grads['W3'] += self.reg * self.params['W3']
        
        dout, grads['W2'], grads['b2'] = affine_relu_backward(dout, cache_2)
        grads['W2'] += self.reg * self.params['W2']
        
        dout, grads['W1'], grads['b1'] = conv_relu_pool_backward(dout, cache_1) # dout.reshape(conv_shape)
